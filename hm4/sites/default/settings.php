 ...
 */
$db_url = 'mysql://openwave:Open@Admin@localhost/hm';
$db_prefix = '';
 ...
 * for you.
 */
$base_url = 'http://216.139.157.254/openwave/hm'; // NO trailing slash!
...
global $gSitePath ,$gDocPath,$apikey,$googlekey;
$gSitePath="http://".$_SERVER['HTTP_HOST']."/openwave/hm/";
$gDocPath=$_SERVER['DOCUMENT_ROOT']."/openwave/hm/";
...
}elseif($_SERVER['HTTP_HOST']=='heardmentality.org'){

$apikey='2__U6kTJnHayxjGFgt8lvNj4w2BiA-eMiiqTq72d0fTxj9S6tYvoyMmoFXDouu1brg';
}else
{
