                                                    ...
                                                    <div id="menu">
                                                        <div class="search">  <form class="home_searchEngine" name="search" method="post" action="">
                                                                ...
                                                                <div class="searchr">
                                                                    ...
                                                                    <div class="stext">  <input type="radio" name="stype[]" id="stype1" value="1" <?php if (isset($_REQUEST['stype'])) {
                                                        if ($_REQUEST['stype'][0] == 1) { ?> checked="checked" <?php }
                                                    } else { ?> checked="checked" <?php } ?>   /></div>
                                                                    <label for="radio" class="slab">Questions</label>
                                                                </div>
                                                                <div class="searchr">

                                                                    <div class="stext">    <input type="radio" name="stype[]" id="stype2" value="2" <?php if (isset($_REQUEST['stype'])) {
                                                        if ($_REQUEST['stype'][0] == 2) { ?> checked="checked" <?php }
                                                    } ?>  /></div>
...
<?php if (count($primary_links)) : ?>
                                        ...
                                        <?php $mb = 1;
                                                        foreach ($primary_links as $link): ?>
                                                            <li><a href="<?php print($gSitePath . $link['href']); ?>" <?php if ($link['title'] == 'About US' || ($link['title'] == 'Add a Issue') || ($link['title'] == 'Privacy')): ?> class="floatbox" rel="nofollow" title="<?php print($link['title']); ?>"<?php endif; ?>><?php print($link['title']); ?></a></li>
<?php endforeach; ?>
