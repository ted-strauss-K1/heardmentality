 ...
 */
require_once "openlogin/Services/Yadis/PlainHTTPFetcher.php";
require_once "openlogin/Services/Yadis/ParanoidHTTPFetcher.php";

/**
 * Need this for parsing HTML (looking for META tags).
 */
require_once "openlogin/Services/Yadis/ParseHTML.php";

/**
 * Need this to parse the XRDS document during Yadis discovery.
 */
require_once "openlogin/Services/Yadis/XRDS.php";
