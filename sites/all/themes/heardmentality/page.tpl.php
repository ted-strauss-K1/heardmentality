	...
	if(isset($_REQUEST['stype']))
{
    ...
    <input type="radio" name="stype" id="stype" id="stype" value="1" <?php if(isset($_REQUEST['stype'])) { if($_REQUEST['stype']==1) {?> checked="checked" <?php } }else{?> checked="checked" <?php }?> />Question
    
    <input type="radio" name="stype" id="stype" id="stype" value="2" <?php if(isset($_REQUEST['stype'])) { if($_REQUEST['stype']==2) {?> checked="checked" <?php } }?> />Users
