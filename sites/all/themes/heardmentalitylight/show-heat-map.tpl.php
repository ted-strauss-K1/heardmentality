...
<ul class="map-stats">
        ...
        <li><span class="count"><?php print number_format($online); ?></span><span class="count-title"><a href="<?php print $base_url; ?>/google/map/online"><?php print t('Online'); ?></a></span></li>
</ul>
