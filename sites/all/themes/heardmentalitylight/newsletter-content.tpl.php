...
<table style="border-spacing: 0; width: 100%">
    <tbody>
    <tr class="tr_outer">
        <td class="td_with_cross_texture"
            style="background: url(<?php print url($theme_path . '/images/cross_hatch_texture.png', array('absolute' => TRUE)); ?>) ;
                border-left: 1px solid #c0c0c0; border-right: 1px solid #c0c0c0; font-family: Arial; padding: 12px;">




            <table width="100%" class="table_title_of_issure"
                   style="border-spacing: 0; width=100%; background: #ffffff; border-top: 1px solid #c0c0c0; border-left: 1px solid #c0c0c0; border-right: 1px solid #c0c0c0; margin: 28px 0 0 0; padding: 20px 12px 8px 12px;">
                <tbody>
                <tr>
                ...
                <tr>
                    <td rowspan="1" colspan="1"
                        style=" width: 100%; font-family: Arial; padding: 2px 8px; font-size: 10px; text-align: right;
                            background: #eee; font-style: italic; background: #76d2dc; border: 1px solid #92b7dd; color: #362750;">
                ...
                <table class="variant_answer"
                       style="border-spacing: 0; width: 100%; background: #ffffff; border-left: 1px solid #c0c0c0; border-right: 1px solid #c0c0c0; padding: 0 12px;">
                    <tbody>
                ...
                <table
                    style="border-spacing: 0; width: 100%; height: 22px; background: #ffffff; border-bottom: 1px solid #c0c0c0; border-left: 1px solid #c0c0c0; border-right: 1px solid #c0c0c0;">
                    <tbody></tbody>
                </table>
