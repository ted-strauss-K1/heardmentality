...
<tr>
  <td
      ...
      <table width="100%"
        ...
        <tr>
          <td rowspan="1" colspan="1"
              style=" width: 100%; font-family: Arial; padding: 2px 8px; font-size: 11px; text-align: right; background: #eee; font-style: italic; background: #76d2dc; border: 1px solid #92b7dd; color: #362750;">
    ...
    <?php endforeach; ?>
      ...
      <table
        style="width: 100%; height: 22px; background: #ffffff; border-bottom: 1px solid #c0c0c0; border-left: 1px solid #c0c0c0; border-right: 1px solid #c0c0c0;"></table>
    <?php endforeach; ?>
