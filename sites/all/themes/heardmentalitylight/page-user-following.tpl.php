...
<body>
	...
	<div class="container">
            <div class="eleven columns">
                <?php if($content):?>
			<h2 class="dinbold page-title"><?php print t('Following Users'); ?></h2>
                        <?php print $content; ?>
                <?php endif; ?>
            </div>
...
<script type="text/javascript">
    ...
    function follow_unfollow(uid, target, act){
        var divid = '#'+uid+'-'+target;
        jQuery.ajax({
            type: 'get',
            url: sitepath+'savefollowing',
            data: {'uid':uid, 'target':target, 'action':act},
