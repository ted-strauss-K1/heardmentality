...
$(document).ready(function() {
	...
	jQuery(function()
	{
		if (navigator.userAgent.indexOf('iPhone') = -1 || navigator.userAgent.indexOf('iPad') = -1 || navigator.userAgent.indexOf('Blackberry') = -1 || navigator.userAgent.indexOf('Android') = -1 || $('body').hasClass('screen_high') || $('body').hasClass('screen_wide')) {
