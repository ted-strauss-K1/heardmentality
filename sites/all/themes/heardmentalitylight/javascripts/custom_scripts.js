 ...
 **/
  ...
  $('#add-new-debate-form').submit(function() {
	$(this).parents('#debate_work_area').find('#leave_comment_area').delay(6500).slideUp(400).removeClass('visible_ar').addClass('hidden_ar');
	$(this).parents('#debate_work_area').find('#add-arg').removeClass('expanded');
  });
