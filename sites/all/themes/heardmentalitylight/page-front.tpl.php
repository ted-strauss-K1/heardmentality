      ...
      <div class="container">
        <div class="sixteen columns top-mobile">
          ...
          <div class="border-bottom clearfix">
            ...
            <span class="banven clearfix"><a href="<?php print $sitelink; ?>issues/0/0/0/0/0/0/0/alltime" class="button vote floatright participate"><?php print t('Be heard!'); ?></a></span>
          </div>
        </div>
      </div>
    </div>
