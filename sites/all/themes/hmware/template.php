...
function hmware_preprocess_page(&$vars) {
    global $theme;
...
//overide default jquery
   ...
   // }
    ...
    unset($js['theme']['sites/all/themes/hmware/scripts/preload.js']); //unset default drupal jquery js
    //print_r($js);
    }
    /*
      if ($vars['content'] && $vars['node']->type != 'forum') {
 ...
 */
function hmware_heartbeat_list($messages, HeartbeatAccess $heartbeatAccess, $link = '') {
...
function hmware_user_profile($account) {
