<div class="dark-grey-box top clearfix">
  ...
  <div class="following clearfix" id="events_users">
    ...
    <?php if ((count($users) < $users_count) && false) : ?>
      <span id="events_users_more" style="display: block; background: #CCC; width: 100%; padding: 5px; text-align: center; border-radius: 5px; clear: both; cursor: pointer;">more</span>
    <?php endif; ?>
  </div>
  <?php if (!empty($users)) : ?>
