        ...
        if ((!empty($cid)) && ($cid == $cat['cat_id'])) {
           // $catlist.='<ul>';
            ...
            foreach ($listscat as $scat) {
                ...
                $style = 'class="sidelinks"';
               $catlist.='&nbsp;&nbsp;<span ' . $style . '><a '.$style.' href="' . $gSitePath . 'searchuser?scid=' . $scat['cat_id'] . '&txt_search=' . $txt_search . '&q_country='.$_GET['q_country'].'&q_state='.$_GET['q_state'].'&q_city'.$_GET['q_city'].'">' . $scat['cat_name'] .$count_row. '</a></span><br/>';
                ...
                if ((!empty($scid)) && ($scid == $scat['cat_id'])) {
                    ...
                    foreach ($listsscat as $sscat) {
                       ...
                       if($count_row1>0){ $count_row1 =  "[$count_row1]";}else{$count_row1='';}
                        ...
                        $style = 'class="sidelinks"';
      $catlist.='&nbsp;&nbsp;<span ' . $style . '><a '.$style.' href="' . $gSitePath . 'searchuser?&sscid=' . $sscat['cat_id'] . '&txt_search=' . $txt_search . '&q_country='.$_GET['q_country'].'&q_state='.$_GET['q_state'].'&q_city='.$_GET['q_city'].'">' . $scat['cat_name']  .$count_row1 . '</a></span><br/>';
