...
if(isset($_POST['process'])){
	...
	*/
	...
	if ( ! isset($error)) {
		...
		*/
		$openid->setReturnURL("http://localhost/heardmentality/dope-openid/login.php?action=verify");
		...
		*/
		$openid->SetTrustRoot('http://localhost/heardmentality/dope-openid/');
...
?>
	...
	<form name="openid_form" id="openid_form" action="".$gSitePath."member/login" method="post" autocomplete="off">
